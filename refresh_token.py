#!/usr/bin/env python3
"""Manzanos Hábitat — refresh del long-lived Instagram access token (~60 días).
Endpoint: GET https://graph.instagram.com/refresh_access_token
  ?grant_type=ig_refresh_token&access_token=<TOKEN>
Guarda el nuevo token en Keychain sobrescribiendo MANZANOSHABITAT_IG_ACCESS_TOKEN.
...
LOG     = os.path.expanduser("~/manzanoshabitat-social/token-refresh.log")
...
def main():
    tok = secret("MANZANOSHABITAT_IG_ACCESS_TOKEN")
    ...
    if new:
        set_secret("MANZANOSHABITAT_IG_ACCESS_TOKEN", new)
